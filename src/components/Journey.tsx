  ...
  return (
    <section id="journey" className="relative scroll-mt-28 py-20 lg:py-28">
      <div className="container-x">
        <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-b from-ink-850/70 to-ink-950/70 p-7 sm:p-10 lg:p-14">
                  ...
                  <div className="group relative h-full">
                    <div className="card card-hover h-full p-6">
                      <div className="flex items-center justify-between">
                        <span className="font-display text-3xl font-black text-brand-400/30 transition group-hover:text-brand-300/70 tabular">
                          {step.n}
                        </span>
                      ...
                      <p className="mt-2.5 text-[12.5px] leading-6 text-white/50">{step.desc}</p>
                    </div>
