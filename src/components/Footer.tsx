import { BRAND, CONTACT, FOOTER_LINKS } from '../config/site'
  ...
  return (
    <footer className="relative mt-8 border-t border-brand-900/10 bg-white">
      ...
      <div className="container-x relative py-14 lg:py-16">
        <div className="grid gap-10 lg:grid-cols-[1.3fr_1fr_1.1fr]">
          {/* الهوية */}
          <div>
            ...
            <p className="mt-5 max-w-sm text-[13.5px] leading-7 text-ink-700">
              صفحة تعريفية بخدماتنا في حسابات Pumps، الفرص الاستثمارية، الاكتتابات والباقات المالية.
