...
export const MARKETS: Market[] = [
  ...
  { id: 'usd', flag: '💵', label: '+جميع الدول العربية', currency: 'دولار أمريكي', symbol: '$', sectionId: 'market-usd' },
]

/** وصف الاشتراك من جميع الدول العربية بعملة USDT — يظهر داخل قسم «+جميع الدول العربية» */
export const USDT_SUBSCRIPTION = {
  eyebrow: 'الاشتراك من جميع الدول العربية',
  title: 'الاشتراك من جميع الدول العربية بعملة USDT',
  desc: 'يمكنك الاشتراك في هذا القسم من أي دولة عربية بعملة USDT (تيثر): اختر الباقة المناسبة، تواصل معنا عبر تيليجرام، ثم أرسل قيمة الباقة من محفظتك الرقمية. تُوضَّح لك الشروط والمدة وآلية التسوية كاملةً قبل إرسال أي مبلغ.',
  points: [
    'الاشتراك متاح من جميع الدول العربية دون الحاجة إلى حساب بنكي محلي أو تحويلات دولية تقليدية.',
    'الدفع بعملة USDT (تيثر) عبر محفظتك الرقمية، ويتم تأكيد التحويل مع فريقنا قبل بدء الاستثمار.',
    'بيانات محفظة USDT الرسمية تُرسل عبر قنوات التواصل الرسمية فقط، وبعد توضيح تفاصيل الباقة المختارة.',
  ],
  note: 'لا تُرسل أي مبلغ قبل التواصل مع فريقنا والتأكد من تفاصيل الباقة وبيانات محفظة USDT الرسمية.',
} as const
...
/** ركائز التفوق — تظهر في قسم «كيف نتقدم بك في الاستثمار؟» */
