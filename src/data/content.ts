...
export const PAMM_STEPS = [
  ...
  { n: '04', title: 'تواصل معنا', desc: 'أرسل طلبك مباشرة عبر واتساب أو تيليجرام.' },
]
...
export const JOURNEY_STEPS = [
  ...
  { n: '03', title: 'تواصل معنا', desc: 'اضغط على واتساب أو تيليجرام.' },
...
export const FAQ_ITEMS = [
  {
    ...
    a: 'لا. الصفحة مخصصة لاستعراض الخدمات والباقات، ويمكنك التواصل معنا مباشرة عبر واتساب أو تيليجرام.',
  },
  {
  ...
  },
  {
    ...
    a: 'نعم، جميع إجراءات الاستفسار الأولي تتم مباشرة من خلال واتساب أو تيليجرام.',
  },
]

/** رسالة واتساب/تيليجرام مبدئية تُبنى حسب الباقة */
...
export const whatsappLink = (label?: string) =>
  `${CONTACT.whatsapp}?text=${encodeURIComponent(buildInquiry(label))}`
